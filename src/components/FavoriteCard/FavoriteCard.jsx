...
const FavoriteCard = ({ favorite }) => {
  ...
  return (
    <div id='favorite-card' className={isDarkMode ? 'dark-mode' : ''}>
      ...
      <div>{favorite.currentWeather.weatherText}</div>
      {isFahrenheit ? (
        <div id='degrees'>{favorite.currentWeather.temperatureF} °F</div>
      ) : (
        <div id='degrees'>{favorite.currentWeather.temperatureC} °C</div>
      )}
      <img
